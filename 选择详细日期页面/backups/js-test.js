...
(function (){
    ...
    boxInSelect=function(todaynum){
        ...
        // var gett = document.getElementsByTagName("td")[parseInt(todaynum)+2];
        // var wasGett = document.getElementsByTagName("td")[wasChangeDay];

        // wasChangeDay = parseInt(todaynum)+2;

        // if (wasChangeDay != 100 &&wasChangeDay != "NaN") {
        //      wasGett.className = "onClickChange-off";
        // }

        //  wasGett.className = "onClickChange-off";

        //  if (gett != "left"&&gett != "right") {}
        // if (gett.className == "onClickChange") {
        //     gett.className = "onClickChange-off";
        // }
        // else{
        //     gett.className = "onClickChange";
        // }
